---
name: pr-description
description: Use when the user asks to "write a PR description", "summarize branch changes", or needs a pull request description generated from the current branch diff.
---
