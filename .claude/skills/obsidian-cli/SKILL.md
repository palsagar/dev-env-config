---
name: obsidian-cli
description: Use when the user asks about Obsidian vault operations, needs to search/read/write notes, manage tags/tasks/properties, or work with daily notes. Provides CLI command reference for Obsidian 1.12+.
---
